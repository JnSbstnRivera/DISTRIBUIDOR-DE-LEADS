...
import type { ColorValue } from '@/lib/pixel/ui/types';
import { LAYOUT_SAVE_DEBOUNCE_MS, ZOOM_MAX, ZOOM_MIN } from '@/lib/pixel/constants';
import type { ExpandDirection } from '@/lib/pixel/editor/editorActions';
import {
  canPlaceFurniture,
  expandLayout,
  getWallPlacementRow,
...
} from '@/lib/pixel/editor/editorActions';
import type { EditorState } from '@/lib/pixel/editor/editorState';
import type { OfficeState } from '@/lib/pixel/engine/officeState';
import {
  getCatalogEntry,
  getRotatedType,
  getToggledType,
} from '@/lib/pixel/layout/furnitureCatalog';
import { defaultZoom } from '@/lib/pixel/toolUtils';
import type {
...
import { TileType } from '@/lib/pixel/types';
import { transport } from '@/lib/pixel/transport';
