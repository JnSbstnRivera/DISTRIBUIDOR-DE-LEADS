...
} from '@/lib/pixel/constants';
import { unlockAudio } from '@/lib/pixel/notificationSound';
  ...
  useEffect(() => {
    ...
    const stop = startGameLoop(canvas, {
      ...
      render: (ctx) => {
        ...
        // ESTÁTICO (Distribuidor): la oficina queda fija y centrada en su cuadro.
        // Sin cámara que siga al agente ni pan → cero movimiento.
